...
const RaidAmount = require('../../preconditions/RaidAmount.js');
const ArgRaidAmount = require('../../preconditions/ArgRaidAmount.js');
const NotOwnGang = require('../../preconditions/NotOwnGang.js');
const RaidPrec = require('../../preconditions/RaidPrec.js');
    ...
    super({
      ...
      args: [
        new patron.Argument({
          ...
          type: 'currency',
          example: '500',
          preconditions: [new MinimumCash(Constants.config.gang.min), RaidAmount]
        }),
        new patron.Argument({
          name: 'gang',
          key: 'gang',
