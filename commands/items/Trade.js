...
class Trade extends patron.Command {
  ...
  async run(msg, args) {
    ...
    if (msg.dbUser.inventory[args.item.names[0]] < args.amount) {
      return msg.createErrorReply('You don\'t have enough of item specified for exchanging.');
    } else if (dbUser.inventory[args.item2.names[0]] === undefined || dbUser.inventory[args.item2.names[0]] <= 0 || dbUser.inventory[args.item2.names[0]] < args.amount2 || dbUser.inventory[args.item2.names[0]] - args.amount2 < 0) {
